...
export const MENTORI = [
  ...
  { nome: "Marlen M.", ruolo: "Redazione Neldiritto · supporto allo studio", rating: 4.9, seguiti: 61, hue: 160, contact: "marlen", real: true,
    msg: "Ciao Marlen, sto usando il Compendio Neldiritto per Diritto penale: posso chiederti un chiarimento sulle cause di giustificazione?" },
...
export const QA = [
  ...
  { tag: "PROGRAMMA", q: "Il programma segue il codice o un manuale specifico?",
    a: "È ancorato al codice penale e a un manuale istituzionale; utile affiancare il Compendio Neldiritto aggiornato per fissare gli schemi. Verifica sempre il programma ufficiale dell'anno in corso.", up: 76, down: 3, who: "Studente del Dipartimento di Giurisprudenza · 2025" },
];
...
export const LIBRARY = [
  { nome: "Compendio di Diritto penale — Parte generale", meta: "38 MB · PDF", tipo: "pdf", scaricato: true },
